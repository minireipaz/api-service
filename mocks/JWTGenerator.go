...
// GenerateServiceUserAssertionJWT provides a mock function with given fields: duration
func (_m *JWTGenerator) GenerateServiceUserAssertionJWT(duration time.Duration) (string, error) {
	ret := _m.Called(duration)

	if len(ret) == 0 {
		panic("no return value specified for GenerateServiceUserAssertionJWT")
	}
